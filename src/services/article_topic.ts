  ...
  return new Promise(async (resolve, reject) => {
    try {
      ...
      if (error) {
        reject({
          success: false,
          message: '创建文章话题关联失败: ' + error.message,
          data: null
        })
        return
      }
  ...
  return new Promise(async (resolve, reject) => {
    try {
      ...
      if (error) {
        reject({
          success: false,
          message: '获取文章话题列表失败: ' + error.message,
          data: null
        })
        return
      }
  ...
  return new Promise(async (resolve, reject) => {
    try {
      ...
      if (error) {
        reject({
          success: false,
          message: '获取话题文章列表失败: ' + error.message,
          data: null
        })
        return
      }
  ...
  return new Promise(async (resolve, reject) => {
    try {
      ...
      if (error) {
        reject({
          success: false,
          message: '删除文章话题关联失败: ' + error.message,
          data: null
        })
        return
      }
  ...
  return new Promise(async (resolve, reject) => {
    try {
      ...
      if (error) {
        reject({
          success: false,
          message: '删除文章所有话题关联失败: ' + error.message,
          data: null
        })
        return
      }
      ...
      resolve({
        success: true,
        message: '删除文章所有话题关联成功',
        data: null
      })
    } catch (err) {
      reject({
        success: false,
        message: '删除文章所有话题关联失败: ' + err,
        data: null
      })
    }
  })
  ...
  return new Promise(async (resolve, reject) => {
    try {
      ...
      if (error) {
        reject({
          success: false,
          message: '删除话题所有文章关联失败: ' + error.message,
          data: null
        })
        return
      }
      ...
      resolve({
        success: true,
        message: '删除话题所有文章关联成功',
        data: null
      })
    } catch (err) {
      reject({
        success: false,
        message: '删除话题所有文章关联失败: ' + err,
        data: null
      })
    }
  })
...
//   })
//   .then(res => {
//     console.log('创建文章话题关联成功', res)
//   })
//   .catch(err => {
//     console.error('创建文章话题关联失败', err)
//   })
  
// // 获取文章的所有话题
// getTopicsByArticleId('dbfa6929-81b2-4647-840f-e621f113815f')
//   .then(res => {
//     console.log('获取文章话题列表成功', res)
//   })
//   .catch(err => {
//     console.error('获取文章话题列表失败', err)
//   })

// // 获取话题的所有文章
// getArticlesByTopicId('589922de-549f-45d9-8062-b378c0571c68')
//   .then(res => {
//     console.log('获取话题文章列表成功', res)
//   })
//   .catch(err => {
//     console.error('获取话题文章列表失败', err)
//   })
